...
<module external.linked.project.id=":react-native-image-picker" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../Example/android" external.system.id="GRADLE" external.system.module.group="Example" external.system.module.version="unspecified" type="JAVA_MODULE" version="4">
